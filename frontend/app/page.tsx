  ...
  const checkServiceability = async () => {
    ...
    try {
      const res = await fetch(
        `${API_BASE_URL}/api/serviceability/${pincode}`
      );
    ...
    <div className="min-h-screen bg-[#fafafa]">
      ...
      <header className="sticky top-0 z-50 bg-white shadow-sm">
        <div className="flex justify-between items-center px-6 py-4 max-w-7xl mx-auto">
          ...
          <h1 className="text-2xl font-extrabold text-green-600 cursor-pointer"
              onClick={() => router.push("/")}>
            MedOnTime
          </h1>
      ...
      <section className="max-w-7xl mx-auto px-6 py-16 grid md:grid-cols-2 gap-10">
        ...
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }}>
          ...
          <h2 className="text-5xl font-extrabold leading-tight">
            Medicines delivered in <span className="text-green-600">30 mins</span>
          </h2>
